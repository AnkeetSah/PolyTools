  ...
  return (
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="w-80 rounded-xl bg-white p-6 shadow-md hover:shadow-lg">
          ...
          <p className="text-gray-400 text-sm">Create QR codes for any URL.</p>
          <a
            href="/link-qr-tools/qr-code-generator"
        ...
        <div className="w-80 rounded-xl bg-white p-6 shadow-md hover:shadow-lg">
          <h3 className="text-lg font-medium">URL Shortener</h3>
          <p className="text-gray-400 text-sm">Shorten long URLs easily.</p>
          <a
            href="/link-qr-tools/url-shortener"
            className="inline-flex items-center text-purple-600 text-sm font-medium mt-3"
          >
            Try Now
          </a>
